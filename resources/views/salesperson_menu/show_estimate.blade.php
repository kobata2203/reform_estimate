...
<body class="estimate-detail">
    ...
    <div class="construction-name">
        ...
        <input type="text" id="construction-name" name="construction_name"
            value="{{ $estimate_info->construction_name ?? '' }}" placeholder="工事名を入力してください">
    </div>
    ...
    <div class="actions-2">
        <div class="action2">
            ...
            {{-- <button type="button" class="btn btn-primary no-print" id="btn_back"
                data-url="{{ url()->previous() }}">戻る</button> --}}
            <a href="{{ $prevurl }}" class="btn btn-primary no-print">
                戻る
            </a>
