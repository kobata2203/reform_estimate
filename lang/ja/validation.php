...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'special_discount' => [
            'numeric' => '特別お値引きの登録に失敗しました。数字を入力してください。',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'username' => 'ユーザー名',
        'year' => '年',
        'item.*' => config('column_names.breakdown_item'),
        'maker.*' => config('column_names.breakdown_maker'),
        'series_name.*' => config('column_names.breakdown_series_name'),
        'item_number.*' => config('column_names.breakdown_item_number'),
